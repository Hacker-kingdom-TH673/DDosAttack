...
try:
	...
	print ("[DDOSAttack]-HTTP FLOOD")

print('''

script : Hacker kingdom TH
Youtub : https://www.youtube.com/channel/UCx8iJxYxvk5MCpxI2biNGkQ
...
def starturl(): # in questa funzione setto l'url per renderlo usabile per il futuro settaggio delle richieste HTTP.
	...
	if url == "":
		print ("Please enter the urlwebsite.")
		starturl()
